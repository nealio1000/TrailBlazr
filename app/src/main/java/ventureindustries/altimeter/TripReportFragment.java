...
import ventureindustries.altimeter.dummy.DummyContent;
import ventureindustries.altimeter.dummy.DummyContent.DummyItem;
 ...
 * interface.
 */
public class TripReportFragment extends Fragment {
    ...
    public static TripReportFragment newInstance(int columnCount) {
